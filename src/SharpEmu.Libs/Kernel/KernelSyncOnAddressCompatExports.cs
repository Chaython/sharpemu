...
public static class KernelSyncOnAddressCompatExports
{
    ...
    private const int HostWaitPollMilliseconds = 5;
    ...
    // 64-bit expected value register argument.
    private static bool TryReadGuestWord(CpuContext ctx, ulong address, int size, out ulong value)
    {
        value = 0;
